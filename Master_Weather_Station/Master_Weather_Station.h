...
#ifndef Master_Weather_Station
    #define Master_Weather_Station
...
//#include <EEPROM.h>     // Need this for reading and writing to EEPROM.
...
/*******************************************************************************************************************
* This definition is for the DS18B20 temp sensors on the One Wire Buss.
* Comment this line out if not using the One Wire Bus temp sensors.
*******************************************************************************************************************/
//#define USINGTEMPSENSORS 1
...
#include "LocalLibrary/ublox.h"            // This library is used to control the uBlox GPS chip attached to the hardware serial port.
#include "LocalLibrary/UartEvent.h"        // This is to use serial DMA for transfering serial data.
#include "LocalLibrary/Buttons.h"          // This class is used to create various shape boxes and touch buttons.
//#include "PString.h"
//#include "Touch.h"
...
//#define DEBUG34   true                // Set Debugging for Update location from GPS Function.
 ...
 *******************************************************************************************************************/
////////////////////////////////////////////////////////////////////////////////////////////////////////
/// These next 3 defines are for the 3 buttons used in the Check for Preferences function.
////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Set initial location of the first button
#define PrefsModeQuestionXPosition ( XMIDDLE - (Xsize * 17) )
#define PrefsModeQuestionYPosition ( YMIDDLE - (Ysize - 16) )
#define PrefsModeQuestionWidth ( 34 * Xsize )
#define PrefsModeQuestionHeight (2 * Ysize)
#define PrefsModeQuestionradius 8

// Set Next location for the yes button
#define YesQuestionXPosition ( XMIDDLE - (Xsize * 17) )
#define YesQuestionYPosition ( YMIDDLE + (2 * Ysize) )
#define YesQuestionWidth ( 8 * Xsize )
#define YesQuestionHeight (3 * Ysize)
#define YesQuestionradius 8

// Set Next location for the no button
#define NoQuestionXPosition ( XMIDDLE + (Xsize * 9) )
#define NoQuestionYPosition ( YMIDDLE + (2 * Ysize) )
#define NoQuestionWidth ( 8 * Xsize )
#define NoQuestionHeight (3 * Ysize)
#define NoQuestionradius 8
