...
// Module    : ER-TFT080-2  8 INCH TFT LCD  800*480
// Lanuage   : C51 Code
// Create    : JAVEN LIU
// Date      : 2014-06-12
	...
	while(1)
		{
			...
			String("ER-TFTM080-2，Optional Chinese / English character library,  MicroSD cord,Falsh.Font Support 2/3/4 times zoom."
